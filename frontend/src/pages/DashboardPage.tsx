...
export default function DashboardPage() {
  ...
  useEffect(() => {
    axios.get<Summary>(`${API}/dashboard/summary/`).then(r => setSummary(r.data)).catch(() => {})
    axios.get<VestingPoint[]>(`${API}/dashboard/timeline/`).then(r => setTimeline(r.data)).catch(() => {})
    axios.get<ActivityItem[]>(`${API}/dashboard/activity/`).then(r => setActivity(r.data)).catch(() => {})
  }, [])
